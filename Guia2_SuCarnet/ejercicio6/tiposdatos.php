...
$concat = $str + $val;
echo '<article>';
echo '<p>El valor de $concat = $str + $num es: <span> = "' . $str . '" + ' . $val . '</span> = <span>';
echo $concat . '</span> y el tipo de dato es: <span>' . gettype($concat) . "</span></p>" . SALTO;
echo '</article>';
echo "\n";
...
$concat = $cad + $str;
echo '<article>';
echo '<p>El valor de $concat = $str + $num es: <span> = "' . $cad . '" + "' . $str . '"</span> = <span>';
echo $concat . '</span> y el tipo de dato es: <span>' . gettype($concat) . "</span></p>" . SALTO;
echo '</article>';
echo "\n";
...
$concat = $val + $cad;
echo '<article>';
echo '<p>El valor de $concat = $str + $num es: <span> = ' . $val . ' + "' . $cad . '"</span> = <span>';
echo $concat . '</span> y el tipo de dato es: <span>' . gettype($concat) . "</span></p>" . SALTO;
echo '</article>';
echo "\n";
...
$concat = $num + $str;
echo '<article>';
echo '<p>El valor de $concat = $str + $num es: <span> = ' . $num . ' + "' . $str . '"</span> = <span>';
echo $concat . '</span> y el tipo de dato es: <span>' . gettype($concat) . "</span></p>" . SALTO;
echo '</article>';
echo "\n";
...
$concat = $num + $cad;
echo '<article>';
echo '<p>El valor de $concat = $str + $num es: <span> = ' . $num . ' + "' . $cad . '"</span> = <span>';
echo $concat . '</span> y el tipo de dato es: <span>' . gettype($concat) . "</span></p>" . SALTO;
echo '</article>';
echo "\n";
...
$concat = $val + $str;
echo '<article>';
echo '<p>El valor de $concat = $str + $num es: <span> = ' . $val . ' + "' . $str . '"</span> = <span>';
echo $concat . '</span> y el tipo de dato es: <span>' . gettype($concat) . "</span></p>" . SALTO;
echo '</article>';
echo "\n";
