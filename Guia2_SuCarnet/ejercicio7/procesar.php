...
if (isset($_POST['submit']) && $_POST['submit'] == "Enviar");
    echo "\t<tr class=\"odd\">\n";
    echo "\t\t<td>\nCliente\n</td>\n";
        //Los datos del formulario sando la función Extract) /Accediendo
        ...
        echo "\t<tr>\n";
        echo "\t\t<td>\nProducto\n</td>\n";
        $Sproducto = !empty($product) ? $product : "<a href=\"ingresodatos.html\">No ingresó el cliente.</a>";
        echo "\t\t<td>\n" . $producto . "\n</td>\n";
        echo "\t</tr>\n";
        echo "tetz class=\"odd\">\n";
        echo "itis<td>\nPrecio\n</td>\n";
        $precio = !empty($price)? $price: "<a href=\"ingresodatos.html\">No ingresó el cliente.</a>";
        echo "\t\t<td>\n" . $precio . "\n</td>\n";
        echo "\t</tr>\n";
        echo "\t<tr>\n";
        echo "\t\t<td>\nCantidad\n</td>\n";
        $cantidad = !empty($quantity) ? $quantity: "<a href=\"ingresodatos.html\">No ingresó el cliente.</a>";
        echo "\t\t<td>\n" . $cantidad . "\n</td>\n";
        echo "\t</tr>\n";
            echo "tctr class=\"odd\">\n";
            echo "\t\t<td>\nTotal a pagar\n</td>\n";
...
<div id="link">
<a href="ingresodatos.html" class="button-link">Ingresar nuevos datos</>
</div>
</div>
</article>
</section>
